...
public class ImageLoader {
        ...
        try {
            ...
            if(in == null) {
                throw new IOException("Couldn't open the image:\n" +
                        IMAGE_DIR + fnm);
            } else if(PlanarFrame.DEBUG_LOAD_IMG) {
    ...
    public boolean hasSprite(String n) {
        if(!this.ready()) return false;
        return imagesMap.containsKey(n);
    }
}